...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        __proto__: main.DormitoryScreen.prototype,
        [Widget_key]: null
      });
    },
    get C2() {
    ...
    get C6() {
      return C[6] = dart.const({
        ...
        [Text_textSpan]: null,
        [Text_data]: "Современное 5-этажное общежитие коридорного типа. Комнаты на 2-3 человека, оборудованы всей необходимой мебелью. На каждом этаже кухня, санузел, душевые на нулевом этаже. Имеется читальный зал, комната отдыха и спортивный уголок. Рядом расположены дендрарий и студенческая столовая."
      });
    },
    get C8() {
    ...
    get C11() {
      return C[11] = dart.constMap(core.String, core.String, []);
    },
    get C12() {
    ...
    get C13() {
      return C[13] = dart.constSet(core.String, ["mailto", "tel", "sms"]);
    },
    get C15() {
    ...
    get C14() {
      return C[14] = dart.constList([C[15] || CT.C15, C[16] || CT.C16, C[17] || CT.C17, C[18] || CT.C18], types.LaunchMode);
    },
    get C19() {
    ...
    get C24() {
      return C[24] = dart.constSet(T.FactoryOfOneSequenceGestureRecognizer(), []);
    },
    get C25() {
      return C[25] = dart.fn(link$.LinkViewController._onGlobalClick, T.MouseEventTovoid());
    },
    get C26() {
      return C[26] = dart.fn(link$.LinkViewController._viewFactory, T.intToElement());
    },
    get C28() {
    ...
    get C27() {
      return C[27] = dart.constList([C[28] || CT.C28, C[29] || CT.C29, C[30] || CT.C30, C[31] || CT.C31, C[32] || CT.C32], types$.PreferredLaunchMode);
    },
    get C33() {
      return C[33] = dart.const({
        __proto__: types$.InAppWebViewConfiguration.prototype,
        [headers$0]: C[11] || CT.C11,
    ...
    get C35() {
      return C[35] = dart.const({
        ...
        [StandardMethodCodec_messageCodec]: C[36] || CT.C36
      });
    },
    get C34() {
      return C[34] = dart.const({
        ...
        [MethodChannel_codec]: C[35] || CT.C35,
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "КубГАУ Общежития", theme: theme_data.ThemeData.new({primarySwatch: colors.Colors.green, fontFamily: "Roboto"}), home: C[1] || CT.C1});
    }
  };
  ...
  main.DormitoryScreen = class DormitoryScreen extends framework.StatefulWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new main.DormitoryScreen.new({key: key});
    }
    createState() {
      return new main._DormitoryScreenState.new();
    }
  };
  (main.DormitoryScreen.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    main.DormitoryScreen.__proto__.new.call(this, {key: key});
    ;
  }).prototype = main.DormitoryScreen.prototype;
  dart.addTypeTests(main.DormitoryScreen);
  dart.addTypeCaches(main.DormitoryScreen);
  dart.setMethodSignature(main.DormitoryScreen, () => ({
    __proto__: dart.getMethods(main.DormitoryScreen.__proto__),
    createState: dart.fnType(framework.State$(main.DormitoryScreen), [])
  }));
  dart.setLibraryUri(main.DormitoryScreen, I[0]);
  var _isFavorite = dart.privateName(main, "_isFavorite");
  var _favoriteCount = dart.privateName(main, "_favoriteCount");
  ...
  var _buildFeatureChip = dart.privateName(main, "_buildFeatureChip");
  ...
  main._DormitoryScreenState = class _DormitoryScreenState extends framework.State$(main.DormitoryScreen) {
    [_launchUrl](url) {
      return async.async(dart.void, function* _launchUrl() {
        if (!(yield url_launcher_uri.launchUrl(core.Uri.parse(url)))) {
          dart.throw(core.Exception.new("Could not launch " + url));
        }
      });
    }
    build(context) {
      let t0, t0$, t0$0;
      return new scaffold.Scaffold.new({body: new scroll_view.CustomScrollView.new({slivers: T.JSArrayOfWidget().of([new app_bar.SliverAppBar.new({expandedHeight: 250, flexibleSpace: new flexible_space_bar.FlexibleSpaceBar.new({background: new image.Image.network("https://sun9-40.userapi.com/s/v1/ig2/m8wRvQ70t4diy--ngylsjzqPH0Q0zKd_zXn2MDsAG7jW6_HqWtmFZS9vQ-jA2h6Ybe842VvvBt7WkXUWPvdXymqG.jpg?quality=95&as=32x23,48x34,72x51,108x77,160x114,240x171,360x257,480x343,540x385,640x457,720x514,1080x771,1280x913,1435x1024&from=bu&u=vkdmz6YeWjWtphWD_EJyCAmvnI8spNDZd83OvRNVUpU&cs=604x431", {fit: box_fit.BoxFit.cover})})}), new basic.SliverToBoxAdapter.new({child: new basic.Padding.new({padding: C[2] || CT.C2, child: new basic.Column.new({crossAxisAlignment: flex.CrossAxisAlignment.start, children: T.JSArrayOfWidget().of([new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.spaceBetween, children: T.JSArrayOfWidget().of([new text.Text.new("Общежитие №20", {style: (t0 = theme.Theme.of(context).textTheme.headlineSmall, t0 == null ? null : t0.copyWith({fontWeight: ui.FontWeight.bold}))}), new icon_button.IconButton.new({icon: new icon$.Icon.new(this[_isFavorite] ? icons.Icons.favorite : icons.Icons.favorite_border, {color: this[_isFavorite] ? colors.Colors.green : colors.Colors.grey}), onPressed: dart.fn(() => {
                            this.setState(dart.fn(() => {
                              let t0, t0$;
                              this[_isFavorite] = !this[_isFavorite];
                              this[_isFavorite] ? (t0 = this[_favoriteCount], this[_favoriteCount] = t0 + 1, t0) : (t0$ = this[_favoriteCount], this[_favoriteCount] = t0$ - 1, t0$);
                            }, T.VoidTovoid()));
                          }, T.VoidTovoid())})])}), C[3] || CT.C3, new text.Text.new("Краснодар, ул. Калинина, 13", {style: (t0$ = theme.Theme.of(context).textTheme.bodyMedium, t0$ == null ? null : t0$.copyWith({color: colors.Colors.grey._get(600)}))}), C[4] || CT.C4, new basic.Wrap.new({spacing: 8, runSpacing: 8, children: T.JSArrayOfWidget().of([this[_buildFeatureChip](icons.Icons.people, "Мест: 400"), this[_buildFeatureChip](icons.Icons.wifi, "Wi-Fi"), this[_buildFeatureChip](icons.Icons.restaurant, "Столовая"), this[_buildFeatureChip](icons.Icons.local_laundry_service, "Прачечная")])}), C[5] || CT.C5, new basic.SizedBox.new({height: 100, child: new scroll_view.ListView.new({scrollDirection: basic_types.Axis.horizontal, children: T.JSArrayOfWidget().of([this[_buildActionButton](context, icons.Icons.call, "Позвонить", colors.Colors.green, dart.fn(() => this[_launchUrl]("tel:+78612622222"), T.VoidTovoid())), this[_buildActionButton](context, icons.Icons.map, "Маршрут", colors.Colors.blue, dart.fn(() => this[_launchUrl]("https://yandex.ru/maps/-/CHRyvLPW"), T.VoidTovoid())), this[_buildActionButton](context, icons.Icons.share, "Поделиться", colors.Colors.orange, dart.fn(() => this[_launchUrl]("https://kubsau.ru"), T.VoidTovoid()))])})}), C[5] || CT.C5, new text.Text.new("О общежитии", {style: (t0$0 = theme.Theme.of(context).textTheme.titleMedium, t0$0 == null ? null : t0$0.copyWith({fontWeight: ui.FontWeight.bold}))}), C[3] || CT.C3, C[6] || CT.C6])})})})])})});
    }
    [_buildFeatureChip](icon, label) {
      return new chip.Chip.new({avatar: new icon$.Icon.new(icon, {size: 18}), label: new text.Text.new(label), backgroundColor: colors.Colors.green._get(50), shape: new rounded_rectangle_border.RoundedRectangleBorder.new({borderRadius: new border_radius.BorderRadius.circular(8)})});
    }
    [_buildActionButton](context, icon, label, color, onPressed) {
      let t0;
      return new basic.Padding.new({padding: C[8] || CT.C8, child: new basic.Column.new({children: T.JSArrayOfWidget().of([new circle_avatar.CircleAvatar.new({backgroundColor: color.withOpacity(0.2), radius: 30, child: new icon_button.IconButton.new({icon: new icon$.Icon.new(icon, {color: color}), onPressed: onPressed})}), C[9] || CT.C9, new text.Text.new(label, {style: (t0 = theme.Theme.of(context).textTheme.labelSmall, t0 == null ? null : t0.copyWith({color: color}))})])})});
    }
    static ['_#new#tearOff']() {
      return new main._DormitoryScreenState.new();
    }
  };
  (main._DormitoryScreenState.new = function() {
    this[_isFavorite] = false;
    this[_favoriteCount] = 213;
    main._DormitoryScreenState.__proto__.new.call(this);
    ;
  }).prototype = main._DormitoryScreenState.prototype;
  dart.addTypeTests(main._DormitoryScreenState);
  dart.addTypeCaches(main._DormitoryScreenState);
  dart.setMethodSignature(main._DormitoryScreenState, () => ({
    __proto__: dart.getMethods(main._DormitoryScreenState.__proto__),
    [_launchUrl]: dart.fnType(async.Future$(dart.void), [core.String]),
    build: dart.fnType(framework.Widget, [framework.BuildContext]),
    [_buildFeatureChip]: dart.fnType(framework.Widget, [icon_data.IconData, core.String]),
    [_buildActionButton]: dart.fnType(framework.Widget, [framework.BuildContext, icon_data.IconData, core.String, ui.Color, dart.fnType(dart.void, [])])
  }));
  dart.setLibraryUri(main._DormitoryScreenState, I[0]);
  dart.setFieldSignature(main._DormitoryScreenState, () => ({
    __proto__: dart.getFields(main._DormitoryScreenState.__proto__),
    [_isFavorite]: dart.fieldType(core.bool),
    [_favoriteCount]: dart.fieldType(core.int)
  }));
  ...
  plugin_platform_interface.PlatformInterface = class PlatformInterface extends core.Object {
    ...
    static _verify(instance, token, opts) {
      ...
      if (preventConstObject && plugin_platform_interface.PlatformInterface._instanceTokens._get(instance) === (C[12] || CT.C12)) {
  ...
  url_launcher_web.UrlLauncherPlugin = class UrlLauncherPlugin extends url_launcher_platform.UrlLauncherPlatform {
    ...
    launch(url, opts) {
      ...
      let headers = opts && 'headers' in opts ? opts.headers : C[11] || CT.C11;
      let webOnlyWindowName = opts && 'webOnlyWindowName' in opts ? opts.webOnlyWindowName : null;
  ...
  url_launcher_uri.launchUrl = function launchUrl(url, opts) {
    let mode = opts && 'mode' in opts ? opts.mode : C[15] || CT.C15;
  ...
  (link$.LinkViewController.new = function(viewId) {
    ...
    this[viewId$] = viewId;
    if (link$.LinkViewController._instances[$isEmpty]) {
      link$.LinkViewController._clickSubscription = html.window[$onClick].listen(C[25] || CT.C25);
    }
  ...
  types$.LaunchOptions = class LaunchOptions extends core.Object {
    ...
    static ['_#new#tearOff'](opts) {
      ...
      let webViewConfiguration = opts && 'webViewConfiguration' in opts ? opts.webViewConfiguration : C[33] || CT.C33;
      let webOnlyWindowName = opts && 'webOnlyWindowName' in opts ? opts.webOnlyWindowName : null;
